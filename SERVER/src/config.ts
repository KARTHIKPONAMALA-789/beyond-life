...
const CONFIG = {
  ...
  DB_URL: process.env.DB_URL || "mongodb://localhost:27017/BeyondLife",
  DB_POOL_SIZE: 10,
  ...
  // Mail Configuration
  SMTP_URL: process.env.SMTP_URL || "smtps://cse.takeoff@gmail.com:digkagfgyxcjltup@smtp.gmail.com:465",
