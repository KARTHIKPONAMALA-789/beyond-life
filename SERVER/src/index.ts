...
const uploadFolder = path.join(publicFolderPath,FOLDER_PATH.DEATHC);
...
app.use("/uploads", express.static(uploadFolder)); //! 📝 Serve Static Files
...
app.use("/api/will", require("./controllers/will").default);
